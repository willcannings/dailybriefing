...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('search_newssource', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('url_wildcard', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('max_pages', self.gf('django.db.models.fields.IntegerField')(default=10000)),
            ('l1', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('l2', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('t1', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('t2', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('a1', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('a2', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('last_hour', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('last_24_hours', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('total_indexed', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('queue_immediate', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('delayed_total', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('delayed_ready', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('search', ['NewsSource'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('search_newssource')
