...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Page.next_analysis'
        raise RuntimeError("Cannot reverse this migration. 'Page.next_analysis' and its values cannot be restored.")
