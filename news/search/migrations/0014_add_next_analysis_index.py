...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Page', fields ['next_analysis']
        db.create_index('search_page', ['next_analysis'])


    def backwards(self, orm):
        
        # Removing index on 'Page', fields ['next_analysis']
        db.delete_index('search_page', ['next_analysis'])
