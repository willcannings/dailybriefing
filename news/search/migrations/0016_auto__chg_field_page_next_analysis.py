...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('search_page', 'next_analysis', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'Page.next_analysis'
        db.alter_column('search_page', 'next_analysis', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
