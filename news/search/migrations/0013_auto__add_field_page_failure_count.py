...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.failure_count'
        db.add_column('search_page', 'failure_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.failure_count'
        db.delete_column('search_page', 'failure_count')
