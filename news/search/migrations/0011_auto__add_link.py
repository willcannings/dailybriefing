...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Link'
        db.create_table('search_link', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='outbound_set', to=orm['search.Page'])),
            ('outbound', self.gf('django.db.models.fields.related.ForeignKey')(related_name='inbound_set', to=orm['search.Page'])),
        ))
        db.send_create_signal('search', ['Link'])


    def backwards(self, orm):
        
        # Deleting model 'Link'
        db.delete_table('search_link')
