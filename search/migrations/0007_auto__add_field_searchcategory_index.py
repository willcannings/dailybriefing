...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SearchCategory.index'
        db.add_column('search_searchcategory', 'index', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SearchCategory.index'
        db.delete_column('search_searchcategory', 'index')
