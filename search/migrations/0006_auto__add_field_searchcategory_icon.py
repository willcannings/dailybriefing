...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SearchCategory.icon'
        db.add_column('search_searchcategory', 'icon', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SearchCategory.icon'
        db.delete_column('search_searchcategory', 'icon')
